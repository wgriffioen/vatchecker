 ...
 */
class BulgarianValidationTest extends \PHPUnit_Framework_TestCase
{
    public function testValidBulgarianFormat()
    {
        $vatNumber = new VATNumber('BG123456789');
        ...
        $vatNumber = new VATNumber('BG1234567890');
